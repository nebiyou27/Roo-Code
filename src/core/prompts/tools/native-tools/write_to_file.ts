...
const INTENT_ID_PARAMETER_DESCRIPTION = `The active intent ID for this write operation.`
const MUTATION_CLASS_PARAMETER_DESCRIPTION = `Semantic mutation class. Must be either AST_REFACTOR or INTENT_EVOLUTION.`
